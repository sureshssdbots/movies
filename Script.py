...
# और फिर इस मैसेज में बटन जोड़ने के लिए, आपको इसे इस तरह से अपडेट करना होगा:

NO_RESULT_TXT_WITH_BUTTON = """<b>ᴛʜɪs ᴍᴇssᴀɢᴇ ɪs ɴᴏᴛ ʀᴇʟᴇᴀsᴇᴅ ᴏʀ ᴀᴅᴅᴇᴅ ɪɴ ᴍʏ ᴅᴀᴛᴀʙᴀsᴇ 🙄</b>

<b>❓ ɪf ʏᴏᴜ ᴡᴀɴᴛ ᴛʜɪs ʟɪɴᴋ ᴛᴏ ʙᴇ ʀᴇʟᴇᴀsᴇᴅ, ᴅᴏ ᴀ ɴᴇᴡ ʀᴇǫᴜᴇsᴛ ʙʏ ᴄʟɪᴄᴋɪɴɢ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ</b>
"""
# बटन बनाने के लिए
request_button = InlineKeyboardButton('➤ ɢᴇᴛ ɪᴛ ʀᴇʟᴇᴀsᴇᴅ', callback_data='new_request')
