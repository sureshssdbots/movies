...
async def start(client, message):
    # Step 1: अस्थायी संदेश भेजें
    temp_msg = await message.reply_text("Processing your request...")  # Temporary loading message
        # Step 3: अस्थायी संदेश को कस्टम वेलकम मैसेज से बदलें
